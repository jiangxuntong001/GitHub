...
/**title位置*/
typedef NS_ENUM(NSUInteger, TFDropDownMenuTitleStyle) {
    TFDropDownMenuTitleStyleLeft,//显示文字在最左侧
    TFDropDownMenuTitleStyleCenter,//显示文字在中间
    TFDropDownMenuTitleStyleRight//显示文字在最右侧
};
//代理点击回调
